...
return [
    ...
    */
    ...
    | specify a cache store that should be used for these sessions.
    |
    */
    ...
    | rid of old sessions from storage. Here are the chances the sweep
    | will run on any given request.
    |
    */
